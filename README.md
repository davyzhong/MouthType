...
[![Tests 测试状态](https://img.shields.io/github/actions/workflow/status/davyzhong/MouthType/ci.yml)](Tests/)
...
> 📸 Screenshots auto-generated by GitHub Actions（GUI 桌面截图 v3.1 升级计划中 — `scripts/screenshot.js` + `.github/workflows/screenshot.yml`）
